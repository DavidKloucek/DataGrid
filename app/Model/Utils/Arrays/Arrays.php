...
namespace DemoApp\Model\Utils\Arrays;
...
class Arrays extends \Nette\Utils\Arrays
{
    ...
    /**
     * @param array $arr
     * @param callable|string $keyMapper
     * @return array
     * @throws ArraysException
     */
    public static function mapKeys(array $arr, callable|string $keyMapper): array
    {
     ...
     */
    public static function filterUniqueObjects(array $arr): array
    {
        $return = [];
        foreach ($arr as $a) {
            if (!in_array($a, $return, true)) {
                $return[] = $a;
            }
        }
        return $return;
